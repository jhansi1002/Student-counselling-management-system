...
import '../../styles/studentdashboard.css'; // Link to the CSS file

// Main Dashboard Component
const StudentDashboard = () => {
  const [studentData, setStudentData] = useState({
    name: 'Jhansi Mandadapu',
    profilePhoto: '',
    email: '221fa04471@gmail.com',
    phone: '1234567890',
    rollNo: '221fa04471',
    marks: [],
    attendance: 93,
    appointments: [],
    messages: 0,
    counselor: { name: 'Mrs.Bharghavi', photo: '', specialization: 'CSE', role: 'Assistent Professor', email: 'bhargavifaculty1@gmail.com' },
    goals: [],
    sessionNotes: [],
  });
  ...
  useEffect(() => {
    const fetchStudentData = async () => {
      try {
        ...
        setStudentData({
          name: data.name || 'Jhansi Mandadapu',
          profilePhoto: data.profilePhoto || 'default-photo-url',
          email: data.email || '221fa04471@gmail.com',
          phone: data.phone || '1234567890',
          rollNo: data.rollNo || '221fa04471',
          marks: data.marks || [],
          attendance: data.attendance || 93,
          appointments: data.appointments || [],
          messages: data.unreadMessages || 0,
          counselor: data.counselor || { name: 'Mrs.Bharghavi', photo: '', specialization: 'CSE', role: 'Assistent Professor', email: 'bhargavifaculty1@gmail.com' },
          goals: data.goals || [],
